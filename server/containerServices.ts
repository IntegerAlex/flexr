...
export async function createImage(username: string, projectName: string, repoLink: string, entryPoint: string, buildCommand: string, runCommand: string): Promise<string> {
